                ...
                e.exports = function () {
                    ...
                    const o = "swal2-",
                        ...
                        ie = e => {
                            ...
                            o.appendChild(n), (e => {
                                ...
                                const e = w(),
                                    ...
                                    l = z(e, i.textarea);
                                t.oninput = oe, n.onchange = oe, r.onchange = oe, a.onchange = oe, l.oninput = oe, o.oninput = () => {
                                    oe(), s.value = o.value
                                }, o.onchange = () => {
                                    oe(), s.value = o.value
                                }
                        ...
                        ce = (e, t) => {
                            const n = L(),
                                o = T();
                            n && o && (t.showConfirmButton || t.showDenyButton || t.showCancelButton ? K(n) : Y(n), V(n, t, "actions"), function (e, t, n) {
                                const o = E(),
                                    s = $(),
                                    r = P();
                                o && s && r && (ue(o, "confirm", n), ue(s, "deny", n), ue(r, "cancel", n), function (e, t, n, o) {
                                    o.buttonsStyling ? (R([e, t, n], i.styled), o.confirmButtonColor && (e.style.backgroundColor = o.confirmButtonColor, R(e, i["default-outline"])), o.denyButtonColor && (t.style.backgroundColor = o.denyButtonColor, R(t, i["default-outline"])), o.cancelButtonColor && (n.style.backgroundColor = o.cancelButtonColor, R(n, i["default-outline"]))) : U([e, t, n], i.styled)
                            ...
                            }(n, o, t), D(o, t.loaderHtml || ""), V(o, t, "loader"))
                        };

                    function ue(e, t, n) {
                        const o = a(t);
                        J(e, n[`show${o}Button`], "inline-block"), D(e, n[`${t}ButtonText`] || ""), e.setAttribute("aria-label", n[`${t}ButtonAriaLabel`] || ""), e.className = i[t], V(e, n, `${t}Button`)
                    }
                    const de = (e, t) => {
                        const n = f();
                        n && (function (e, t) {
                            ...
                            t && (t in i ? R(e, i[t]) : (l('The "position" parameter is not valid, defaulting to "center"'), R(e, i.center)))
                        }(n, t.position), function (e, t) {
                            t && R(e, i[`grow-${t}`])
                        }(n, t.grow), V(n, t, "container"))
                    };
                        ...
                        be = (e, t, n) => {
                            if (n.inputLabel) {
                                const o = document.createElement("label"),
                                    s = i["input-label"];
                                o.setAttribute("for", e.id), o.className = s, "object" == typeof n.customClass && R(o, n.customClass.inputLabel), o.innerText = n.inputLabel, t.insertAdjacentElement("beforebegin", o)
                            }
                        },
                    ...
                    ve.text = ve.email = ve.password = ve.number = ve.tel = ve.url = (e, t) => (we(e, t.inputValue), be(e, e, t), fe(e, t), e.type = t.input, e), ve.file = (e, t) => (be(e, e, t), fe(e, t), e), ve.range = (e, t) => {
                        ...
                        if (e.textContent = "", t.inputPlaceholder) {
                            ...
                            D(n, t.inputPlaceholder), n.value = "", n.disabled = !0, n.selected = !0, e.appendChild(n)
                        }
                        return be(e, e, t), e
                    ...
                    const Ce = (e, t) => {
                        const o = A();
                        o && (V(o, t, "htmlContainer"), t.html ? (se(t.html, o), K(o, "block")) : t.text ? (o.textContent = t.text, K(o, "block")) : Y(o), ((e, t) => {
                            const o = w(),
                                s = n.innerParams.get(e),
                                r = !s || t.input !== s.input;
                            pe.forEach((e => {
                                const n = z(o, i[e]);
                                ge(e, t.inputAttributes), n.className = i[e], r && Y(n)
                            })), t.input && (r && me(t), he(t))
                        })(e, t))
                    },
                        Ae = (e, t) => {
                            for (const [n, o] of Object.entries(s)) t.icon !== n && U(e, o);
                            R(e, t.icon && s[t.icon]), xe(e, t), ke(), V(e, t, "icon")
                        },
                        ke = () => {
                            const e = w();
                            if (!e) return;
                        ...
                        Be = (e, t) => {
                            if (!t.icon) return;
                            let n, o = e.innerHTML;
                            t.iconHtml ? n = Ee(t.iconHtml) : "success" === t.icon ? (n = '\n  <div class="swal2-success-circular-line-left"></div>\n  <span class="swal2-success-line-tip"></span> <span class="swal2-success-line-long"></span>\n  <div class="swal2-success-ring"></div> <div class="swal2-success-fix"></div>\n  <div class="swal2-success-circular-line-right"></div>\n', o = o.replace(/ style=".*?"/g, "")) : n = "error" === t.icon ? '\n  <span class="swal2-x-mark">\n    <span class="swal2-x-mark-line-left"></span>\n    <span class="swal2-x-mark-line-right"></span>\n  </span>\n' : Ee({
                                question: "?",
                                warning: "!",
                                info: "i"
                            }[t.icon]), o.trim() !== n.trim() && D(e, n)
                        },
                        xe = (e, t) => {
                            if (t.iconColor) {
                                e.style.color = t.iconColor, e.style.borderColor = t.iconColor;
                                for (const n of [".swal2-success-line-tip", ".swal2-success-line-long", ".swal2-x-mark-line-left", ".swal2-x-mark-line-right"]) Z(e, n, "backgroundColor", t.iconColor);
                        ...
                        Pe = (e, t) => {
                            const n = t.showClass || {};
                            e.className = `${i.popup} ${X(e) ? n.popup : ""}`, t.toast ? (R([document.documentElement, document.body], i["toast-shown"]), R(e, i.toast)) : R(e, i.modal), V(e, t, "popup"), "string" == typeof t.customClass && R(e, t.customClass), t.icon && R(e, i[`icon-${t.icon}`])
                        },
                        $e = e => {
                        ...
                        Le = (e, t) => {
                            ((e, t) => {
                                ...
                                if (n && o) {
                                    ...
                                    W(o, "padding", t.padding), t.color && (o.style.color = t.color), t.background && (o.style.background = t.background), Y(x()), Pe(o, t)
                                }
                            })(0, t), de(0, t), ((e, t) => {
                                const n = B();
                                if (!n) return;
                                ...
                                o && 0 !== o.length && void 0 !== s ? (K(n), n.textContent = "", s >= o.length && l("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), o.forEach(((e, r) => {
                                    const a = $e(e);
                                    if (n.appendChild(a), r === s && R(a, i["active-progress-step"]), r !== o.length - 1) {
                                        const e = Te(t);
                                        n.appendChild(e)
                                    }
                                }))) : Y(n)
                                ...
                                const n = k();
                                n && (t.imageUrl ? (K(n, ""), n.setAttribute("src", t.imageUrl), n.setAttribute("alt", t.imageAlt || ""), W(n, "width", t.imageWidth), W(n, "height", t.imageHeight), n.className = i.image, V(n, t, "image")) : Y(n))
                            })(0, t), ((e, t) => {
                                const n = C();
                                n && (J(n, t.title || t.titleText, "block"), t.title && se(t.title, n), t.titleText && (n.innerText = t.titleText), V(n, t, "title"))
                            })(0, t), ((e, t) => {
                                const n = j();
                                n && (D(n, t.closeButtonHtml || ""), V(n, t, "closeButton"), J(n, t.showCloseButton), n.setAttribute("aria-label", t.closeButtonAriaLabel || ""))
                        ...
                        De = (e, t, o) => {
                            ...
                            i && (t.isComposing || 229 === t.keyCode || (i.stopKeydownPropagation && t.stopPropagation(), "Enter" === t.key ? qe(e, t, i) : "Tab" === t.key ? Ve(t) : [...Ie, ...He].includes(t.key) ? Ne(t.key) : "Escape" === t.key && _e(t, i, o)))
                        },
                        qe = (e, t, n) => {
                    ...
                    const Re = () => {
                        ...
                        We = e => {
                            const t = e.target,
                                n = f();
                            return !(Ke(e) || Ye(e) || t !== n && (G(n) || !(t instanceof HTMLElement) || "INPUT" === t.tagName || "TEXTAREA" === t.tagName || G(A()) && A().contains(t)))
                        },
                    ...
                    function Xe(n, o, s, r) {
                        H() ? st(n, r) : (t(s).then((() => st(n, r))), je(e)), Ue ? (o.setAttribute("style", "display:none !important"), o.removeAttribute("class"), o.innerHTML = "") : o.remove(), I() && (null !== Ze && (document.body.style.paddingRight = `${Ze}px`, Ze = null), (() => {
                    ...
                    const Qe = e => {
                        ...
                        const i = f();
                        return U(i, o.showClass.backdrop), R(i, o.hideClass.backdrop), ot(e, t, o), !0
                    };
                    ...
                    const tt = e => {
                        ...
                        it = (t, n, o, i, s) => {
                            e.swalCloseEventFinishedCallback = Xe.bind(null, t, o, i, s), n.addEventListener(le, (function (t) {
                        ...
                        rt = e => {
                            ...
                            t || new Dn, t = w();
                            const n = T();
                            H() ? Y(v()) : at(t, e), K(n), t.setAttribute("data-loading", "true"), t.setAttribute("aria-busy", "true"), t.focus()
                        },
                        at = (e, t) => {
                            const n = L(),
                                o = T();
                            !t && X(E()) && (t = E()), K(n), t && (Y(t), o.setAttribute("data-button-to-replace", t.className)), o.parentNode.insertBefore(o, t), R([e, n], i.loading)
                        },
                        lt = e => e.checked ? 1 : 0,
                        ...
                        pt = (e, t) => {
                            const n = e.getInput();
                            Y(n), g(t.inputValue).then((o => {
                                n.value = "number" === t.input ? `${parseFloat(o) || 0}` : `${o}`, K(n), n.focus(), e.hideLoading()
                            })).catch((t => {
                                c(`Error in inputValue promise: ${t}`), n.value = "", K(n), n.focus(), e.hideLoading()
                            }))
                        },
                        mt = {
                            select: (e, t, n) => {
                                const o = z(e, i.select),
                                    s = (e, t, o) => {
                                        ...
                                        i.value = o, D(i, t), i.selected = ht(o, n.inputValue), e.appendChild(i)
                                    };
                                t.forEach((e => {
                                    const t = e[0],
                                        n = e[1];
                            ...
                            radio: (e, t, n) => {
                                ...
                                t.forEach((e => {
                                    ...
                                    D(l, s), l.className = i.label, a.appendChild(r), a.appendChild(l), o.appendChild(a)
                                }));
                        ...
                        bt = (e, t, o) => {
                            const i = n.innerParams.get(e);
                            e.disableInput(), Promise.resolve().then((() => g(i.inputValidator(t, i.validationMessage)))).then((n => {
                                e.enableButtons(), e.enableInput(), n ? e.showValidationMessage(n) : "deny" === o ? yt(e, t) : Ct(e, t)
                            }))
                        },
                        yt = (e, t) => {
                            const o = n.innerParams.get(e || void 0);
                            o.showLoaderOnDeny && rt($()), o.preDeny ? (e.isAwaitingPromise = !0, Promise.resolve().then((() => g(o.preDeny(t, o.validationMessage)))).then((n => {
                                !1 === n ? (e.hideLoading(), tt(e)) : e.close({
                                    isDenied: !0,
                                    value: void 0 === n ? t : n
                                })
                            })).catch((t => vt(e || void 0, t)))) : e.close({
                                isDenied: !0,
                                value: t
                            })
                        },
                        ...
                        Ct = (e, t) => {
                            const o = n.innerParams.get(e || void 0);
                            o.showLoaderOnConfirm && rt(), o.preConfirm ? (e.resetValidationMessage(), e.isAwaitingPromise = !0, Promise.resolve().then((() => g(o.preConfirm(t, o.validationMessage)))).then((n => {
                                X(x()) || !1 === n ? (e.hideLoading(), tt(e)) : wt(e, void 0 === n ? t : n)
                            })).catch((t => vt(e || void 0, t)))) : wt(e, t)
                        };
                    ...
                    const kt = e => {
                        ...
                        t.length ? K(t[0], "inline-block") : !X(E()) && !X($()) && !X(P()) && Y(e.actions)
                    };
                    ...
                    function St(e) {
                        ...
                        D(t.validationMessage, e), t.validationMessage.className = i["validation-message"], o.customClass && o.customClass.validationMessage && R(t.validationMessage, o.customClass.validationMessage), K(t.validationMessage);
                        const s = this.getInput();
                        s && (s.setAttribute("aria-invalid", !0), s.setAttribute("aria-describedby", i["validation-message"]), _(s), R(s, i.inputerror))
                    }
                    ...
                    const jt = {
                        ...
                        Mt = ["allowEscapeKey", "allowOutsideClick", "background", "buttonsStyling", "cancelButtonAriaLabel", "cancelButtonColor", "cancelButtonText", "closeButtonAriaLabel", "closeButtonHtml", "color", "confirmButtonAriaLabel", "confirmButtonColor", "confirmButtonText", "currentProgressStep", "customClass", "denyButtonAriaLabel", "denyButtonColor", "denyButtonText", "didClose", "didDestroy", "footer", "hideClass", "html", "icon", "iconColor", "iconHtml", "imageAlt", "imageHeight", "imageUrl", "imageWidth", "preConfirm", "preDeny", "progressSteps", "returnFocus", "reverseButtons", "showCancelButton", "showCloseButton", "showConfirmButton", "showDenyButton", "text", "title", "titleText", "willClose"],
                        It = {},
                    ...
                    function Rt(e) {
                        const t = w(),
                            o = n.innerParams.get(this);
                        if (!t || q(t, o.hideClass.popup)) return void l("You're trying to update the closed or closing popup, that won't work. Use the update() method in preConfirm parameter or show a new popup.");
                        const i = Ut(e),
                            s = Object.assign({}, o, i);
                        Le(this, s), n.innerParams.set(this, s), Object.defineProperties(this, {
                            params: {
                    ...
                    const Wt = t => {
                        ...
                        Kt = e => {
                            e.isAwaitingPromise ? (Yt(n, e), e.isAwaitingPromise = !0) : (Yt(Fe, e), Yt(n, e), delete e.isAwaitingPromise, delete e.disableButtons, delete e.enableButtons, delete e.getInput, delete e.disableInput, delete e.enableInput, delete e.hideLoading, delete e.disableLoading, delete e.showValidationMessage, delete e.resetValidationMessage, delete e.close, delete e.closePopup, delete e.closeModal, delete e.closeToast, delete e.rejectPromise, delete e.update, delete e._destroy)
                        },
                        Yt = (e, t) => {
                    ...
                    const Jt = (e, t, o) => {
                        t.popup.onclick = () => {
                            ...
                            t && (Xt(t) || t.timer || t.input) || o(Oe.close)
                        }
                    },
                    ...
                    const Qt = e => {
                        ...
                        tn = (e, t, o) => {
                            t.container.onclick = i => {
                                ...
                                Gt ? Gt = !1 : i.target === t.container && p(s.allowOutsideClick) && o(Oe.backdrop)
                            }
                        },
                    ...
                    const dn = ["swal-title", "swal-html", "swal-footer"],
                        pn = e => {
                            ...
                            return Array.from(e.querySelectorAll("swal-param")).forEach((e => {
                                ...
                                t[n] = "boolean" == typeof jt[n] ? "false" !== o : "object" == typeof jt[n] ? JSON.parse(o) : o
                            })), t
                        },
                        mn = e => {
                            const t = {};
                        ...
                        Cn = t => {
                            ...
                            }))), H() || e.previousActiveElement || (e.previousActiveElement = document.activeElement), "function" == typeof t.didOpen && setTimeout((() => t.didOpen(o))), U(n, i["no-transition"])
                        },
                        An = e => {
                            const t = w();
                            if (e.target !== t) return;
                            const n = f();
                            t.removeEventListener(le, An), n.style.overflowY = "auto"
                        },
                        kn = (e, t) => {
                            le && Q(t) ? (e.style.overflowY = "hidden", t.addEventListener(le, An)) : e.style.overflowY = "auto"
                        },
                        Bn = (e, t, n) => {
                            (() => {
                        ...
                        xn = (e, t, n) => {
                            R(e, n.showClass.backdrop), t.style.setProperty("opacity", "0", "important"), K(t, "grid"), setTimeout((() => {
                                R(t, n.showClass.popup), t.style.removeProperty("opacity")
                            }), 10), R([document.documentElement, document.body], i.shown), n.heightAuto && n.backdrop && !n.toast && R([document.documentElement, document.body], i["height-auto"])
                        };
                    var En = {
                    ...
                    class Tn {
                        ...
                        _main(t) {
                            ...
                            (e => {
                                ...
                                for (const t in e) Nt(t), e.toast && _t(t), Ft(t)
                            })(Object.assign({}, o, t)), e.currentInstance && (e.currentInstance._destroy(), I() && Re()), e.currentInstance = $n;
                            const i = Sn(t, o);
                            Pn(i), Object.freeze(i), e.timeout && (e.timeout.stop(), delete e.timeout), clearTimeout(e.restoreFocusTimeout);
                            const s = On($n);
                            return Le($n, i), n.innerParams.set($n, i), Ln($n, s, i)
                        }
                        then(e) {
                    ...
                    const Ln = (t, o, i) => new Promise(((s, r) => {
                        ...
                        Fe.swalPromiseResolve.set(t, s), Fe.swalPromiseReject.set(t, r), o.confirmButton.onclick = () => {
                            (e => {
                                const t = n.innerParams.get(e);
                            ...
                            je(t), n.toast || (t.keydownHandler = t => De(e, t, o), t.keydownTarget = n.keydownListenerCapture ? window : w(), t.keydownListenerCapture = n.keydownListenerCapture, t.keydownTarget.addEventListener("keydown", t.keydownHandler, {
                        ...
                        })(t, i), Cn(i), jn(e, i, a), Mn(o, i), setTimeout((() => {
                        ...
                        Mn = (e, t) => {
                            t.toast || (p(t.allowEnterKey) ? In(e, t) || Me(-1, 1) : Hn())
                        },
                        In = (e, t) => t.focusDeny && X(e.denyButton) ? (e.denyButton.focus(), !0) : t.focusCancel && X(e.cancelButton) ? (e.cancelButton.focus(), !0) : !(!t.focusConfirm || !X(e.confirmButton) || (e.confirmButton.focus(), 0)),
                        Hn = () => {
                    ...
                    Tn.prototype.disableButtons = $t, Tn.prototype.enableButtons = Pt, Tn.prototype.getInput = Bt, Tn.prototype.disableInput = Lt, Tn.prototype.enableInput = Tt, Tn.prototype.hideLoading = At, Tn.prototype.disableLoading = At, Tn.prototype.showValidationMessage = St, Tn.prototype.resetValidationMessage = Ot, Tn.prototype.close = Ge, Tn.prototype.closePopup = Ge, Tn.prototype.closeModal = Ge, Tn.prototype.closeToast = Ge, Tn.prototype.rejectPromise = et, Tn.prototype.update = Rt, Tn.prototype._destroy = zt, Object.assign(Tn, cn), Object.keys(Zt).forEach((e => {
                        Tn[e] = function () {
                            return $n && $n[e] ? $n[e](...arguments) : null
                        }
                    })), Tn.DismissReason = Oe, Tn.version = "11.7.16";
                    const Dn = Tn;
